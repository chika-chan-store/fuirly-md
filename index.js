...
function title() {
	...
	console.log(color(`\n${themeemoji} Creator : ᴹᴿ᭄ MadhanXs`,'magenta'))
console.log(color(`${themeemoji} GITHUB: verifcenter `,'magenta'))
...
} else if (connection === "open") { XeonBotInc.sendMessage(owner + "@s.whatsapp.net", { text: `*Bot started!*\n\n\n_Don't forget to support, bro :)_\n\nGitHub: https://github.com/verifcenter\n\nInstsgram: https://instagram.com/madhanfajr_?igshid=ZGUzMzM3NWJiOQ==\n\nWhatsApp Pm: wa.me/6285810357399\n\nDonate: https://telegra.ph/file/e8c6640414ffc9cdb8632.jpg \n\n\n_*Thanks to*_\n_*Lord Allah Swt*_\n_*Myself*_\n_*Family*_\n_*Friends who helped me assemble this script*_` }); }
